...
<div class="d-flex justify-content-center align-items-center mt-4">
    <p class="prodCountZag">Товара в наличие: </p>
    <p id="ProdCount">0</p>
</div>

<h3 class="text-center mt-2">Действия с товаром: </h3>
...
<form id="ProductChange" class="mt-4" data-productid="false">
    <div class="d-flex justify-content-center mb-4">
        <label class="m-0 pt-1">Кол-во товара: </label>
        <div class="btn-group ml-2" role="group" aria-label="Basic example" id="prodCounter">
            <button type="button" class="btn btn-secondary" id="minus">-</button>
            <input type="text" class="countInput" placeholder="1" value="1" id="ProductCounter" max="999" min="1" maxlength="3">
